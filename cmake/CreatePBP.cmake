...
macro(create_pbp_file)
    ...
    if(BUILD_PRX)
    set(TARGET_TYPE "$<TARGET_FILE_DIR:${ARG_TARGET}>/psp_artifact/${ARG_TARGET}.prx")
    else()
    set(TARGET_TYPE "$<TARGET_FILE_DIR:${ARG_TARGET}>/psp_artifact/${ARG_TARGET}") 
    endif(BUILD_PRX)
    ...
    add_custom_command(
            ...
            "${ARG_BACKGROUND_PATH}" "NULL" "${TARGET_TYPE}" "NULL"
